...
**YOU MUST NOT:**
- ❌ Start implementing without reading approved analysis (analysis.md)
- ❌ Make changes beyond the planned fix scope
- ❌ Proceed to verification without explicit user approval
- ❌ Skip testing the implemented fix
...
```yaml
# Required State to Start Fix Phase
prerequisites:
  - report.md: must_exist_and_be_approved
  - analysis.md: must_exist_and_be_approved
  - current_phase: must_be_fix
  - fix_plan: must_be_documented_in_analysis
```

**RULE**: You can ONLY start fixing if both report.md and analysis.md exist and were user-approved
...
### 🛑 FIX PHASE MANDATORY STOP POINT

**BEFORE PROCEEDING, COMPLETE THIS CHECKLIST:**

```
✅ FIX IMPLEMENTATION CHECKLIST:
□ Fix implemented according to analysis.md plan
□ Code follows project standards and conventions
□ Fix tested with original bug reproduction steps
□ No regressions introduced in related functionality
□ User explicitly approved with "yes", "approved", or "looks good"

IF ANY CHECKBOX IS UNCHECKED, YOU MUST NOT PROCEED TO VERIFICATION PHASE
```

#### USER APPROVAL STEP

- **Present summary of changes made**
- **Show test results confirming fix works**
