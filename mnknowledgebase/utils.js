...
const kbOCRConfig = {
  ...
  postProcessingRules: [
    ...
    },
    {
      pattern: /\s*，|,\s*/g,
      replacement: ", ",
      description: "统一逗号格式（中英文逗号 + 空格）"
    },
    {
      pattern: /\s*:\s*/g,
      replacement: ": ",
      description: "统一冒号格式（冒号 + 空格）"
    },
    {
      pattern: /\{?(∂𝔻)\}?/g,
      replacement: "𝕋",
    ...
    // 1. 编号前置 + 带名称 + 有内容
    {
      ...
      replacement: '$3; $2',
      description: '【编号前置-英文】移除编号，将名称移到末尾（4.1.3 Theorem (Name) Content → Content; Name）'
    },
    {
      pattern: /^\d+(?:\.\d+)*\s+(定理|引理|推论|命题|定义|例子)\s*[（(]([^)）]+)[)）][:.:]?\s*(.+)/g,
      replacement: '$3; $2',
      description: '【编号前置-中文】移除编号，将名称移到末尾（4.1.3 定理 (名称) 内容 → 内容; 名称）'
    },
    ...
    // 2. 编号前置 + 带名称 + 无内容
    {
      pattern: /^\d+(?:\.\d+)*\s+(Theorem|Lemma|Corollary|Proposition|Definition|Example)\s*\(([^)]+)\)[:.:]?\s*$/ig,
      replacement: '$2',
      description: '【编号前置-英文】仅保留名称（4.1.3 Theorem (Name) → Name）'
    },
    {
      pattern: /^\d+(?:\.\d+)*\s+(定理|引理|推论|命题|定义|例子)\s*[（(]([^)）]+)[)）][:.:]?\s*$/g,
      replacement: '$2',
      description: '【编号前置-中文】仅保留名称（4.1.3 定理 (名称) → 名称）'
    },
    ...
    // 3. 编号前置 + 无名称 + 有内容
    {
      ...
      replacement: '$2',
      description: '【编号前置-英文】移除编号和关键词，保留内容（4.1.3 Theorem Content → Content）'
    },
    {
      pattern: /^\d+(?:\.\d+)*\s+(定理|引理|推论|命题|定义|例子|例|反例|注释|注|练习|习题|问题|题)[:.:]?\s*(.+)/g,
      replacement: '$2',
      description: '【编号前置-中文】移除编号和关键词，保留内容（4.1.3 定理 内容 → 内容）'
    },
    ...
    // 4. 编号前置 + 无名称 + 无内容（兜底）
    {
      pattern: /^\d+(?:\.\d+)*\s+(Theorem|Lemma|Corollary|Proposition|Definition|Example|Counterexample|Remark|Exercise|Problem)[:.:]?\s*$/ig,
      replacement: '',
      description: '【编号前置-英文】移除整行（4.1.3 Theorem → 空）'
    },
    {
      pattern: /^\d+(?:\.\d+)*\s+(定理|引理|推论|命题|定义|例子|例|反例|注释|注|练习|习题|问题|题)[:.:]?\s*$/g,
      replacement: '',
...

    {
      pattern: /C_ϕ/g,
      replacement: "Cᵩ",
      description: "替换下标 phi 符号"
    },
    {
      pattern: /lim‾/g,
      replacement: "limsup",
      description: "替换极限符号（上极限）"
    },
    {
      pattern: /如果/g,
      replacement: "若",
